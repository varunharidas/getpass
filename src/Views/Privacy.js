...
export default class About extends Component { 
  ...
  render () {     
    ...
    const meta = {
        title: 'Privacy — Getpass',
        description: 'Privacy policy and Terms',
        canonical: 'https://getpass.xyz/privacy',
        meta: {
          charset: 'utf-8',
          name: {
            keywords: 'privacy policy getpass'
          }
        }
      };
...
<p>Getpass ("us", "we", or "our") operates the https://getpass.xyz website (the "Service").</p>
...
<p>Getpass uses the collected data for various purposes:</p>    
<ul>
...
<p>Getpass will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2>Disclosure Of Data</h2>

<h3>Legal Requirements</h3>
<p>Getpass may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of Getpass</li>
...
<ul>
        <li>By email: hello@getpass.xyz</li>
